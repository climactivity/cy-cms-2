...
<div
	class="shadow-md rounded-sm bg-white flex flex-col items-stretch"
	style="--list-cols: {listCols}"
>
...
<style lang="scss">
	.list-item {
		@apply py-2 px-4 border-b-[1px] border-solid border-zinc-200 grid grid-flow-col place-items-stretch w-full;
