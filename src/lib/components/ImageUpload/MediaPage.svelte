...
<div class={showToast ? 'p-3 mb-3 absolute' : 'hidden absolute'}>
	<div class="mr-1" success isOpen={showToast}>
		...
		<div>Dein Bild ist jetzt hochgeladen! Kopier den Permalink mit dem Button in der Gallery!</div>
	</div>
</div>

<button success on:click={toggleModal} style="width: 100%"> Bild hochladen </button>
